...
from predata.datapre import reuterskerasdata
from net.RNNet import reutersKerasNet
import time
...
data = reuterskerasdata(batchsize=BATCH_SIZE,seq_len=args.seq_len,out_dim=args.out_dim)
...
model = reutersKerasNet(MAX_WORDS, EMB_SIZE, HID_SIZE, DROPOUT).to(DEVICE)
print(model)
